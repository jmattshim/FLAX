#ifndef _CSD_CRC_FUNC_H
#define _CSD_CRC_FUNC_H
...
{
	return Level_DecodeFixed32((char *)(p));
}
...
void set_crc32c_to_block(char *output, size_t size, char *trailer)
{
	memset(trailer, 0, kBlockTrailerSize);
	trailer[0] = 0; // Type KNoCompression
	uint32_t crc = Value(output, size);
